/// Taken from vapor's pennybot: https://github.com/vapor/penny-bot/blob/e28344e6bf186b4de1cd9dcda804a6ed900d792f/CODE/Sources/PennyBOT/%2BLogger.swift
...
extension Logger {
  ...
  func report(
    ...
    if let loggable {
      self.report(
        message, response: loggable, metadata: metadata, source: source, file: file,
